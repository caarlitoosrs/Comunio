...
public class DAOEscudos {
    ...
    private void cargarEquipos() {
        equipos.add(new Equipo("Alcala", R.drawable.alcala));
        equipos.add(new Equipo("Arsenal", R.drawable.arsenal));
        equipos.add(new Equipo("Milan", R.drawable.milan));
        equipos.add(new Equipo("Real Madrid", R.drawable.realmadrid));
        equipos.add(new Equipo("Roma", R.drawable.roma));
    }
